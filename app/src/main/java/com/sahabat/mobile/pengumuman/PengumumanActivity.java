package com.sahabat.mobile.pengumuman;
...
import com.sahabat.mobile.helper.NotificationUtils;

/**
 * Created by GILBERT on 15/08/2017.
 */

public class PengumumanActivity extends AppCompatActivity {

    private static final String TAG = PengumumanActivity.class.getSimpleName();
